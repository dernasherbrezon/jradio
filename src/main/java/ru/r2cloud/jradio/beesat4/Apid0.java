...
public class Apid0 {
	...
	public Apid0(DataInputStream dis) throws IOException {
		...
		ACSWHX = bis.readShort();
		ACSWHY = bis.readShort();
		ACSWHZ = bis.readShort();
		ACSQ00 = bis.readShort() * 0.0001f;
		ACSQ01 = bis.readShort() * 0.0001f;
		ACSQ02 = bis.readShort() * 0.0001f;
		ACSQ03 = bis.readShort() * 0.0001f;
		ACSSUX = bis.readShort() * 0.0001f;
		ACSSUY = bis.readShort() * 0.0001f;
		ACSSUZ = bis.readShort() * 0.0001f;
		ACSM0X = bis.readShort() * 10;
		ACSM0Y = bis.readShort() * 10;
		ACSM0Z = bis.readShort() * 10;
		ACSQDES00 = bis.readShort() * 0.0001f;
		ACSQDES01 = bis.readShort() * 0.0001f;
		ACSQDES02 = bis.readShort() * 0.0001f;
		...
		ACSC1X = bis.readShort() * 0.001f;
		ACSC1Y = bis.readShort() * 0.001f;
		ACSC1Z = bis.readShort() * 0.001f;
		...
		ACSTEMEX = bis.readShort();
		ACSTEMEY = bis.readShort();
		ACSTEMEZ = bis.readShort();
		ACSEFX = bis.readShort();
		ACSEFY = bis.readShort();
		ACSEFZ = bis.readShort();
