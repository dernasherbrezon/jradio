...
public class Apid1 {
	...
	public Apid1(DataInputStream dis) throws IOException {
		...
		ACSTEMEVELX = bis.readUnsignedShort() * 0.001f;
		ACSTEMEVELY = bis.readUnsignedShort() * 0.001f;
		ACSTEMEVELZ = bis.readUnsignedShort() * 0.001f;
		ACSMAGIFX = bis.readUnsignedShort() * 10;
		ACSMAGIFY = bis.readUnsignedShort() * 10;
		ACSMAGIFZ = bis.readUnsignedShort() * 10;
		ACSSUNIFX = bis.readUnsignedShort() * 0.0001f;
		ACSSUNIFY = bis.readUnsignedShort() * 0.0001f;
		ACSSUNIFZ = bis.readUnsignedShort() * 0.0001f;
		ACSCMX = bis.readUnsignedShort() * 0.001f;
		ACSCMY = bis.readUnsignedShort() * 0.001f;
		ACSCMZ = bis.readUnsignedShort() * 0.001f;
		ACGM2Y = bis.readUnsignedShort() * -0.00104167f;
		ACGM2Z = bis.readUnsignedShort() * 0.00104167f;
		ACGM2X = bis.readUnsignedShort() * -0.00104167f;
		...
		ACSACY = bis.readUnsignedShort() * -0.061f;
		ACSACZ = bis.readUnsignedShort() * 0.061f;
		ACSACX = bis.readUnsignedShort() * -0.061f;
		...
		ACMM2Y = bis.readUnsignedShort() * -7.642841368f + 7968.73f;
		ACMM2Z = bis.readUnsignedShort() * 8.032315024f - 10266.647f;
		ACMM2X = bis.readUnsignedShort() * -7.890292416f - 11584.291f;
		ACSAMY = bis.readUnsignedShort() * -0.061f;
		ACSAMZ = bis.readUnsignedShort() * 0.061f;
		ACSAMX = bis.readUnsignedShort() * -0.061f;
		bis.skipBits(3);
	}
