...
public class Smog1Telemetry3 {
	...
	public Smog1Telemetry3(LittleEndianDataInputStream dis) throws IOException {
		...
		obcTemperature = dis.readShort() / 10.0f;
		...
		msen = new Smog1Msen[2];
		for (int i = 0; i < msen.length; i++) {
			msen[i] = new Smog1Msen(dis);
		}
	...
	public void setMsen(Smog1Msen[] msen) {
		this.msen = msen;
	}
