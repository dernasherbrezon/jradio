...
public class Mysat1Beacon extends Beacon {
	...
	public void readBeacon(byte[] data) throws IOException, UncorrectableException {
		...
		obcDaughterBoardTemp = dis.readUnsignedByte() - 128;
		epsBatteryTemp = dis.readUnsignedByte() - 128;
		epsBoardTemp = dis.readUnsignedByte() - 128;
		antsTemp = dis.readUnsignedByte() - 128;
		trxvuTemp = dis.readUnsignedByte() - 128;
		adcsTemp = dis.readUnsignedByte() - 128;
