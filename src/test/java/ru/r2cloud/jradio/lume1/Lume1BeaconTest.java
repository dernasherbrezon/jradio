...
public class Lume1BeaconTest {
	...
	public void testId2() throws Exception {
		byte[] data = ViterbiTest.hexStringToByteArray(
				"");
	...
	public void testId4() throws Exception {
		byte[] data = ViterbiTest
				.hexStringToByteArray("82F39D000411D7000E0801FFFF0065100319896A03E8461302376E2A000401C3510D6842ED3332C301547300000000000000000000000000000000000000000000000000013EA2F0003E9D2548BED7FB4BC38143D0439429E9C24167040101000100010000000100FB00010000000000070000668B0000000B33C6");
		Lume1Beacon beacon = new Lume1Beacon();
		beacon.readBeacon(data);
	...
	public void testId5() throws Exception {
		byte[] data = ViterbiTest.hexStringToByteArray(
				"");
		Lume1Beacon beacon = new Lume1Beacon();
		beacon.readBeacon(data);
