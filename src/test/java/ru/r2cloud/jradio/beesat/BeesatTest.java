...
public class BeesatTest {

	private Beesat input;
	...
	public void testDecodeTelemetry() throws Exception {
		...
		TaggedStreamToPdu pdu = new TaggedStreamToPdu(new UnpackedToPacked(new FixedLengthTagger(correlateTag, BeesatBeacon.MAX_SIZE * 8), 1, Endianness.GR_MSB_FIRST, Byte.class));
		input = new Beesat(pdu);
		assertTrue(input.hasNext());
		BeesatBeacon beacon = input.next();
