...
public class FoxTest {
	...
	public void testSuccess() throws Exception {
		...
		CorrelateSyncword pdu = new CorrelateSyncword(demod, 0, codes, Fox.SLOW_FRAME_SIZE * 10);
	...
	public void testHighSpeed() throws Exception {
		...
		codes.add("0011111010");
		codes.add("1100000101");
		CorrelateSyncword pdu = new CorrelateSyncword(demod, 0, codes, HighSpeedFox.HIGH_SPEED_FRAME_SIZE * 10);
