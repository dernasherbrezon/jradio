...
public class ConstellationSoftDecoderTest {
	...
	public void test() throws Exception {
		...
		source = new ConstellationSoftDecoder(new InputStreamSource(ConstellationSoftDecoderTest.class.getClassLoader().getResourceAsStream("clockmm.bin")), constel);
		try (InputStreamSource is = new InputStreamSource(ConstellationSoftDecoderTest.class.getClassLoader().getResourceAsStream("constdec.bin"))) {
			int index = 0;
			while (true) {
