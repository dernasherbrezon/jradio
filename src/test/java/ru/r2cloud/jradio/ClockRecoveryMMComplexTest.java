...
public class ClockRecoveryMMComplexTest {
	...
	public void testLRPT() throws Exception {
		...
		source = new ClockRecoveryMMComplex(new InputStreamSource(new FileInputStream("/Users/dernasherbrezon/Downloads/costas2.bin")), omega, (float) (0.001 * 0.001 / 4), 0.5f, 0.001f, 0.005f);
		try (InputStreamSource is = new InputStreamSource(new FileInputStream("/Users/dernasherbrezon/Downloads/clockmm2.bin"))) {
			int index = 0;
			while (true) {
