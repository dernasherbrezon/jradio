...
public class SpectogramPaletteTest {
	
	private SpectogramPalette palette;
	...
	@Before
	public void start() {
		palette = new SpectogramPalette(0.0f, -160.0f, 0x000000, 0x0000e7, 0x0094ff, 0x00ffb8, 0x2eff00, 0xffff00, 0xff8800, 0xff0000, 0xff007c);
	}
