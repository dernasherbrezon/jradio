...
public class Floripasat1Test {
	...
	public void testSuccess() throws Exception {
		...
		CorrelateSyncword correlate = new CorrelateSyncword(demod, 5, "01011101111001100010101001111110", (80 + 3) * 8);
	...
	public void testDownlink() throws Exception {
		...
		CorrelateSyncword correlate = new CorrelateSyncword(demod, 5, "01011101111001100010101001111110", (255 + 3) * 8);
